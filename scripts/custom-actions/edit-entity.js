function f($event, widgetContext, entityId, entityName, htmlTemplate, additionalParams, entityLabel) {
  ...
  function EditEntityDialogController(instance) {
    ...
    vm.save = function () {
      ...
      widgetContext.rxjs.forkJoin([saveAttributes(entityId), saveRelations(entityId), saveEntity()]).subscribe(function () {
