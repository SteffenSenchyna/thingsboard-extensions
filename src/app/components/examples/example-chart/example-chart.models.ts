...
export const valueCartCardLayouts = Object.keys(
  ValueChartCardLayout
) as ValueChartCardLayout[];

export const valueChartCardLayoutTranslations = new Map<
  ValueChartCardLayout,
  string
>([
...
export const valueChartCardLayoutImages = new Map<ValueChartCardLayout, string>(
  [
    [
      ValueChartCardLayout.left,
      "assets/widget/value-chart-card/left-layout.svg",
    ],
    [
      ValueChartCardLayout.right,
      "assets/widget/value-chart-card/right-layout.svg",
    ],
  ]
);
